...
* @Last Modified time: 2016-04-29 18:40:19
*/
'use strict'
...
module.exports = class { // CPS API
  ...
  */
  get (param) { // 获取CPS商品详情
    ...
    return this.vdian.api(param, 'vdian.cps.item.get')
  }
  ...
  * itemid  商品ID
  */
  getpublic (param) { // 获取商品公开详情
    if (typeof param !== 'object') param = { itemid: param }
    return this.vdian.api(param, 'vdian.item.getpublic')
  }
}
